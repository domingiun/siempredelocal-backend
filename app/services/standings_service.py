...
def build_round_of_32_bracket(
    ...
    matches = [
        ...
        {"match_number": 74, "home": pick("E", 1), "away": best_third_from(list("ABCDF")),
         "home_label": "1° Grupo E", "away_label": "Mejor 3° (A/B/C/D/F)"},
        ...
        {"match_number": 77, "home": pick("I", 1), "away": best_third_from(list("CDFGH")),
         "home_label": "1° Grupo I", "away_label": "Mejor 3° (C/D/F/G/H)"},
        ...
        {"match_number": 82, "home": pick("G", 1), "away": best_third_from(list("AEHIJ")),
         "home_label": "1° Grupo G", "away_label": "Mejor 3° (A/E/H/I/J)"},
        ...
        {"match_number": 85, "home": pick("B", 1), "away": best_third_from(list("EFGIJ")),
         "home_label": "1° Grupo B", "away_label": "Mejor 3° (E/F/G/I/J)"},
